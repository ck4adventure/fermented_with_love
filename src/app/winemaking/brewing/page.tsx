...
export default function PublicBrewingPage() {
    ...
    <>
      <section className="hero" style={{ paddingBottom: '3rem' }}>
        <div className="container">
          <span className="hero-eyebrow">Public Log</span>
          <h1 className="hero-title">
            What&apos;s <em>Brewing</em>
          </h1>
          <p className="hero-lead" style={{ marginBottom: 0 }}>
            A look at what&apos;s bubbling right now, and what&apos;s been bottled.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '5rem 0' }}>
              ...
              <p style={{ color: 'var(--stone)' }}>Nothing public yet. Check back soon!</p>
            </div>
          ) : (
            <>
              {active.length > 0 && (
